...
import org.firstinspires.ftc.teamcode.Hardware.HardwareOuttake;
...
//    }
    ...
    public ArrayList<TestItem> getTests() {
        ...
        tests.add(new Test_Motor("rightFront-positive power", 0.01, HardwareDrivetrain.rightFront));
        tests.add(new Test_Motor("leftFront-positive power", 0.01, HardwareDrivetrain.leftFront));
        tests.add(new Test_Motor("rightRear-positive power", 0.01, HardwareDrivetrain.rightRear));
        tests.add(new Test_Motor("leftRear-positive power", 0.01, HardwareDrivetrain.leftRear));

//        tests.add(new Test_Servo("Test_Servo", rightOuttakeArm, 0.0, 1.0));
