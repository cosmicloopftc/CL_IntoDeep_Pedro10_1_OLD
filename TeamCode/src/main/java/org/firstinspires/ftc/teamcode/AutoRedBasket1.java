...
//    //private Pose redScorePose = new Pose(23.6 * 5 + 6, 14, Math.toRadians(135));      //(AUTORedNetX, AUTORedNetY, Math.toRadians(135));;
    ...
    public void buildPaths() {
        ...
        preLoadScoreStop = follower.pathBuilder()
                  .addPath(new BezierLine(new Point(startPose), new Point(preScorePose)))
                  .setLinearHeadingInterpolation(startPose.getHeading(), preScorePose.getHeading())
                  .build();
        preLoadScore = follower.pathBuilder()
                .addPath(new BezierLine(new Point(preScorePose), new Point(redScorePose)))
                .setLinearHeadingInterpolation(preScorePose.getHeading(), redScorePose.getHeading())
                .build();
